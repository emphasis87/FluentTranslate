namespace FluentTranslate.Services
{
    public class FluentDebugEqualityComparer : IFluentEqualityComparer
    {
        ...
        protected virtual string GetTypeName(IFluentElement element) => "";// FluentTranslateEntities.GetType(element);
        ...
        public bool Equals(IFluentElement? x, IFluentElement? y)
        {
            ...
            {
                (FluentResource a, FluentResource b) => Equals(a, b),
        ...
        protected bool Equals(FluentResource x, FluentResource y)
        {
        ...
        protected int GetHashCode(FluentResource resource) => GetHashCode(resource.Content);
